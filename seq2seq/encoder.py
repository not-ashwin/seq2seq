...
class Encoder(nn.Module):
    def __init__(self, vocab_dim, embedding_dim, enc_hidden_dim, dec_hidden_dim, dropout=0.5):
    ...
    def forward(self, src, src_len):
        ...
        outputs, _ = nn.utils.rnn.pad_packed_sequence(packed_output) # returns unpacked tensors and lengths in tuple
        ...
        cell = torch.tanh(self.cell_resize(torch.cat((cell[-2,:,:], cell[-1,:,:]), dim = 1)))
